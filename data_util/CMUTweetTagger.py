...
# on server
# RUN_TAGGER_CMD = "java -XX:ParallelGCThreads=2 -Xmx500m -jar /afs/andrew.cmu.edu/usr14/gramadur/private/Abusive-Language-Detection-Categorization/ark-tweet-nlp-0.3.2/ark-tweet-nlp-0.3.2.jar"
